 ...
 * <body ng-controller="MainCtrl">
 *   <ion-side-menus>
 *     <ion-side-menus-content>
 *       Content!
 *       <button ng-click="toggleLeftSideMenu()">
 *         Toggle Left Side Menu
 *       </button>
 *     </ion-side-menus-content>
 *     <ion-side-menus side="left">
 *       Left Menu!
 *     <ion-side-menus>
 *   </ion-side-menus>
 * </body>
...
.controller('$ionicRefresher', [
  ...
  function($scope, $attrs, $element, $ionicBind, $timeout) {
    ...
    // DOM manipulation and broadcast methods core by JS and Native Scrolling
 ...
 * the most common use-case. However, for added flexibility, any valid glyphter query could be added
 ...
 * level side-menus page. Navigating in to child views will hide the menu-
 ...
 * `ion-side-menus-content`, so that when the element is clicked, the opened side menu will
 * automatically close.
 *
 ...
 * side menu, and have at least 2 child elements: 1 `<ion-side-menus-content>` for the center content,
 * and one or more `<ion-side-menus>` directives for each side menu(left/right) that you wish to place.
 *
 * ```html
 * <ion-side-menus>
 *   <!-- Center content -->
 *   <ion-side-menus-content ng-controller="ContentController">
 *   </ion-side-menus-content>
 *
 *   <!-- Left menu -->
 *   <ion-side-menus side="left">
